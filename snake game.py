...
def snake(blockSize, snakelist):
    ...
    for size in snakelist:
        ...
        pygame.draw.rect(Disp, black,[size[0]+5,size[1],blockSize,blockSize],2)
...
def message_to_screen(msg, color):
    ...
    Disp.blit(screen_text, [window_width/2, window_height/2])
...
def gameLoop():
    ...
    while not gameExit:
        ...
        while gameOver == True:
            ...
            message_to_screen("Game over, press c to play again or Q to quit", (0,255,0))
        ...
        pygame.draw.rect(Disp, red, [randomAppleX,randomAppleY,AppleThickness,AppleThickness])
